		    		...
		    		success: function() // Success
		 			{  
			   		...
			   		error: function() // Fail
			   		{
						...
						{
							$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='false' aria-describedby='errormsg'>&times;</button><strong>"+$form.attr('fail-msg')+"</strong></div></div>");
						}	
			   		},
		   		});
			}
